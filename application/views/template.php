...
<script>
    ...
    CKEDITOR.replace('deskripsi', {
        ...
        filebrowserBrowseUrl: '<?= base_url('assets/vendor/file') ?>',
        filebrowserImageBrowseUrl: '<?= base_url('assets/vendor/file') ?>?type=Images',
        filebrowserUploadUrl: '<?= base_url('assets/vendor/file') ?>?command=QuickUpload&type=Files',
        filebrowserImageUploadUrl: '<?= base_url('assets/vendor/file') ?>?command=QuickUpload&type=Images'
    });
</script>
